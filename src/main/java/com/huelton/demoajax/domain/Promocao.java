package com.huelton.demoajax.domain;
...
public class Promocao implements Serializable {
	...
	@NotBlank(message="O link é requerido")
	...
	@NotNull(message="Um preco é requerido")
	@NumberFormat(style = Style.CURRENCY, pattern = "#,##0.00")// este formado no preco por causa do MYSQL
